...
# HPC-optimized version with CUDA support
...
OUT_DIR = "./checkpoint_hpc"
ADAPTER_DIR = os.getenv("EUROLLM_LORA_ADAPTER_HPC", "./adapter_hpc")

MAX_LEN = 512
BATCH = 8  # Increased for HPC GPU
GRAD_ACC = 4
EPOCHS = 3
LR = 2e-5
WARMUP = 0.05
...
model = AutoModelForCausalLM.from_pretrained(
    MODEL_ID,
    device_map="auto",  # Auto-detect best GPU mapping
